...
詳細: [docs/ja/roadmap.md](./docs/ja/roadmap.md)

## ドキュメント

- [多言語ドキュメント](./docs/i18n.md)
- [開発ロードマップ](./docs/ja/roadmap.md) · [English](./docs/roadmap.md)
- [MCP Dashboard（利用者向け）](./docs/ja/dashboard.md) · [English](./docs/dashboard.md)
- [MCP トークン削減調査](./docs/ja/mcp-reduction-survey.md)
- [MCP Dashboard（開発者向け）](./docs/ja/dev/dashboard.md)
- [ベンチマーク](./docs/ja/benchmarks.md)
- [リポジトリ構成](./docs/ja/structure.md)
- [OSS vs Cloud 機能分割](./docs/ja/ecosystem/plans.md)
- [Docker](./docs/ja/docker.md)
- [Gate リリース](./docs/ja/releases.md)
- [アーキテクチャ](./docs/ja/architecture.md)
- [ログスキーマ](./docs/ja/log-schema.md)
